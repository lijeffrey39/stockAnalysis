...
def getTopStocks(numStocks):
    ...
    stocks = ['TSLA', 'AMD', 'ROKU', 'WKHS', 'AAPL', 'FCEL', 'SLS', 'ACB', 'TEUM', 'AMZN', 'NIO', 'NFLX', 'UGAZ', 'CEI', 'TVIX', 'OSTK', 'NAKD', 'FB', 'ADXS', 'YRIV', 'AMRN', 'DIS', 'BB', 'CHK', 'SHOP', 'SQ', 'ENPH', 'SNAP', 'TOPS', 'BA', 'BABA', 'TRXC', 'MSFT', 'AGRX', 'GE', 'MDR', 'JAGX', 'MNKD', 'HSGX', 'RKDA', 'NAK', 'MU', 'ADMP', 'PCG', 'NBEV', 'QQQ', 'PRPO', 'TBLT', 'TEVA', 'TWTR', 'NVCN', 'CGC', 'MNK', 'FIT', 'TTNP', 'ATVI', 'NVDA', 'DPW', 'CRMD', 'CRON', 'IQ', 'NBRV', 'JNUG', 'TNDM', 'X', 'SESN', 'NTEC', 'PTN', 'XXII', 'AUPH', 'SES', 'RBZ', 'INPX', 'XBIO', 'IBIO', 'ULTA', 'APHA', 'RAD', 'TXMD', 'BAC', 'YUMA', 'CLF', 'AVEO', 'ADMA', 'AWSM', 'JD', 'MCD', 'DWT', 'AMRH', 'PLUG', 'CGIX', 'ENDP', 'GLD', 'TWLO', 'BZUN', 'JCP', 'TRVN', 'GUSH', 'TLRY', 'DGAZ']
    stocks.remove('HSGX')
    stocks.remove('AMZN')
    # stocks.remove('ACB')
    # stocks.remove('CHK')
